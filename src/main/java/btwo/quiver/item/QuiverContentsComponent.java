...
public class QuiverContentsComponent implements TooltipData {
    ...
    public static final PacketCodec<RegistryByteBuf, QuiverContentsComponent> PACKET_CODEC = ItemStack.PACKET_CODEC
            ...
            .xmap(QuiverContentsComponent::new, component -> component.stacks);
    private static final Fraction NESTED_QUIVER_OCCUPANCY = Fraction.getFraction(1, 16);
    ...
    static Fraction getOccupancy(ItemStack stack) {
        QuiverContentsComponent quiverContentsComponent = stack.get(DataComponentTypes.QUIVER_CONTENTS);
        if (quiverContentsComponent != null) {
            return NESTED_QUIVER_OCCUPANCY.add(quiverContentsComponent.getOccupancy());
        } else {
            List<BeehiveBlockEntity.BeeData> list = stack.getOrDefault(net.minecraft.component.DataComponentTypes.BEES, List.of());
